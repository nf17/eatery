    ...
    func getAccountBalance() {
        getHTML { (html: NSString) -> () in
            ...
            if self.stage == .fundsHome {
                ...
                self.accountBalance.swipes = swipes != "" ? String(swipes[swipes.characters.index(after: swipes.startIndex)..<swipes.characters.index(before: swipes.endIndex)]) : "Unlimited"
            }
        }
    }
